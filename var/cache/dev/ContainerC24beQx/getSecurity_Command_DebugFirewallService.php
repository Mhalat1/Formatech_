...
class getSecurity_Command_DebugFirewallService extends App_KernelDevContainer
{
    ...
    {
        $container->privates['security.command.debug_firewall'] = $instance = new \Symfony\Bundle\SecurityBundle\Command\DebugFirewallCommand($container->parameters['security.firewalls'], ($container->privates['.service_locator.bsoXAxw'] ?? self::get_ServiceLocator_BsoXAxwService($container)), ($container->privates['.service_locator.YbySDCA'] ?? $container->load('get_ServiceLocator_YbySDCAService')), ['main' => [($container->privates['App\\Security\\UsersAuthenticator'] ?? $container->load('getUsersAuthenticatorService')), ($container->privates['security.authenticator.remember_me.main'] ?? $container->load('getSecurity_Authenticator_RememberMe_MainService'))]], false);
