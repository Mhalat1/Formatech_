...
class Utilisateur extends \App\Entity\Utilisateur implements \Doctrine\ORM\Proxy\InternalProxy
{
    ...
    private const LAZY_OBJECT_PROPERTY_SCOPES = [
        "\0".parent::class."\0".'abonnement_id' => [parent::class, 'abonnement_id', null],
        ...
        "\0".parent::class."\0".'subscriptionCount' => [parent::class, 'subscriptionCount', null],
        "\0".parent::class."\0".'subscriptionType' => [parent::class, 'subscriptionType', null],
        "\0".parent::class."\0".'telephone' => [parent::class, 'telephone', null],
        "\0".parent::class."\0".'trialEndsAt' => [parent::class, 'trialEndsAt', null],
        'abonnement_id' => [parent::class, 'abonnement_id', null],
        ...
        'subscriptionCount' => [parent::class, 'subscriptionCount', null],
        'subscriptionType' => [parent::class, 'subscriptionType', null],
        'telephone' => [parent::class, 'telephone', null],
        'trialEndsAt' => [parent::class, 'trialEndsAt', null],
    ];
