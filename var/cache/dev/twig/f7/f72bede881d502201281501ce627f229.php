...
class __TwigTemplate_1d9a7c89fb64f028d7b325e66ddd9462 extends Template
{
...
";
    ...
    public function block_toolbar(array $context, array $blocks = []): iterable
    {
        ...
        if (((CoreExtension::getAttribute($this->env, $this->source, ($context["collector"] ?? null), "violationsCount", [], "any", false, false, false, 33) > 0) || Twig\Extension\CoreExtension::length($this->env->getCharset(), CoreExtension::getAttribute($this->env, $this->source, ($context["collector"] ?? null), "calls", [], "any", false, false, false, 33)))) {
            // line 34
            yield "        ";
            $context["status_color"] = ((CoreExtension::getAttribute($this->env, $this->source, ($context["collector"] ?? null), "violationsCount", [], "any", false, false, false, 34)) ? ("red") : (""));
            // line 35
            yield "        ";
    ...
    public function block_menu(array $context, array $blocks = []): iterable
    {
        ...
        yield ((CoreExtension::getAttribute($this->env, $this->source, ($context["collector"] ?? null), "violationsCount", [], "any", false, false, false, 58)) ? (" label-status-error") : (""));
        yield " ";
...
";
    ...
    ";
        ...
        foreach ($context['_seq'] as $context["_key"] => $context["call"]) {
            ...
            // line 76
            yield "                ";
            if (CoreExtension::getAttribute($this->env, $this->source, ($context["caller"] ?? null), "line", [], "any", false, false, false, 76)) {
                // line 77
                yield "                    ";
