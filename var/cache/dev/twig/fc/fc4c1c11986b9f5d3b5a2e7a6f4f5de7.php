...
class __TwigTemplate_32514a9480ebfcc0dce31cc0fccfd2bf extends Template
{
...
";
        ...
        ";
            ...
            if (CoreExtension::getAttribute($this->env, $this->source, ($context["controller"] ?? null), "class", [], "any", true, true, false, 89)) {
                ...
                // line 91
                yield ((CoreExtension::getAttribute($this->env, $this->source, ($context["controller"] ?? null), "method", [], "any", false, false, false, 91)) ? ($this->env->getRuntime('Twig\Runtime\EscaperRuntime')->escape((" :: " . CoreExtension::getAttribute($this->env, $this->source, ($context["controller"] ?? null), "method", [], "any", false, false, false, 91)), "html", null, true)) : (""));
            } else {
                // line 93
    ...
    {
        return new Source("", "@WebProfiler/Profiler/_request_summary.html.twig", "C:\\Users\\halat\\OneDrive\\Desktop\\Formatech_\\vendor\\symfony\\web-profiler-bundle\\Resources\\views\\Profiler\\_request_summary.html.twig");
    }
}
