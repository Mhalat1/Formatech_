...
class __TwigTemplate_8d458b97bc502221a9a8e1135f4452a3 extends Template
{
...
<html lang=\"en\">
    <head>
        ...
        // line 11
        yield "        ";
        $context["status_code"] = (( !(null === ($context["request_collector"] ?? null))) ? (((CoreExtension::getAttribute($this->env, $this->source, ($context["request_collector"] ?? null), "statuscode", [], "any", true, true, false, 11)) ? (Twig\Extension\CoreExtension::default(CoreExtension::getAttribute($this->env, $this->source, ($context["request_collector"] ?? null), "statuscode", [], "any", false, false, false, 11), 0)) : (0))) : (0));
        // line 12
        yield "        ";
...
";
    ...
    {
        return new Source("", "@WebProfiler/Profiler/base.html.twig", "C:\\Users\\halat\\OneDrive\\Desktop\\Formatech_\\vendor\\symfony\\web-profiler-bundle\\Resources\\views\\Profiler\\base.html.twig");
    }
}
