...
class FormContactType extends AbstractType
{
        ...
        $builder
            ...
            ->add('NomModule', TextType::class, [
                ...
                ->add('Dates', DateType::class, [
                    'label' => 'Dates *',
                    'widget' => 'single_text',
                    // Add format option to ensure proper string conversion
                    'format' => 'yyyy-MM-dd',  // Or your preferred date format
                    'html5' => true,
                    'attr' => [
                        'class' => 'form-control'
                    ],
                    // Add this to handle the data transformation properly
                    'input' => 'string',  // This tells Symfony to expect/store a string
    ...
    public function configureOptions(OptionsResolver $resolver): void
    {
        $resolver->setDefaults([
            ...
            'csrf_protection' => true,  // Déplacé au bon niveau
            'csrf_field_name' => '_token',
            'csrf_token_id' => 'contact_form',
            'attr' => ['class' => 'contact-form']  // Uniquement les attributs HTML ici
        ]);
    }
}